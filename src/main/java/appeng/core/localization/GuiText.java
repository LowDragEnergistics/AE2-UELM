...
public enum GuiText implements LocalizationEnum {
    ...
    FluidSubstitutions("Fluid Substitutions: %s"),
    Fluids("Fluids"),
    Fluix("Fluix"),
    ...
    SelfLoopMatrix("ME Self-Loop Matrix"),
    SelfLoopMatrixTarget("Target"),
    SelfLoopMatrixAmount("Amount"),
    ...
    SuperMEReplenisher("Super ME Replenisher"),
    SuperMEReplenisherBytesTotal("Bytes Total: %s"),
    SuperMEReplenisherBytesUsed("Bytes Used: %s"),
    SuperMEReplenisherStored("Stored: %s"),
    SuperMEReplenisherTarget("Target: %s"),
    SuperMEReplenisherThreshold("Threshold"),
    SuperMEReplenisherTickRate("Tick Rate"),
    SuperMEReplenisherUnlimited("Unlimited"),
    Suspend("Suspend"),
    ...
    Stores("Stores"),
    Substitute("Using Substitutions: %s"),
    TankAmount("Amount: %d"),
    ...
    TunnelPatternInfo1("Use as an input when encoding processing patterns."),
    TunnelPatternInfo2("Its inputs are inlined into the encoded pattern."),
    TunnelPatternInfo3("Indexed by UUID, so you can change its contents"),
    TunnelPatternInfo4("or rename it without updating referencing patterns."),
    TunnelPatternUuid("UUID: %s"),
    Types("Types"),
